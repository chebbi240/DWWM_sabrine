...
<!--
  ...
  fin de formation mise au 20 aout 2020
-->
<?php
// Déclaration des objets date
$finForm = new DateTime('2020-08-20');
$today = new DateTime();
...
$finForm = intval(date(mktime(0, 0, 0, 8, 20, 2020)));
...
-->
<?php
$dateError = DateTime::createFromFormat("d/m/Y", '17/17/2019'); // var_dump : object(DateTime)#3 (3) { ["date"]=> string(26) "2004-05-04 15:57:12.000000" ["timezone_type"]=> int(3) ["timezone"]=> string(3) "UTC" }
...
$heure = $today->format("_H\hi_"); // '\' annule ce qui suit
echo $heure;
?><br><hr>
<h1>Exercice 8</h1>
<!--
