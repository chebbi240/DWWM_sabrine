       ...
       <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="form_add.php">Ajouter un produit</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="form_update.php">Modifier un produit</a>
                    </li>
                </ul>            
            </div>
        </nav>
...
<h1 class= "text-center" >Formulaire d'ajout</h1>
  <form action="script_add.php" method="POST" id="ajout_produit" enctype="multipart/form-data">
