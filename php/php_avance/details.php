...
<body class="container-fluid col-lg-10">
   ...
   <button class="btn btn-warning" ><a class="nav-link" href="from_update.php?pro_id=<?php echo $row->pro_id;?>">Modifier</a></button>
   <button class="btn btn-danger"><a class="nav-link"  href="form_delete.php?pro_id=<?php echo $row->pro_id;?>">Supprimer</a></button>
    </div><br/>
    </form>
    <?php
