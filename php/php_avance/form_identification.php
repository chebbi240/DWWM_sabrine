...
<form id="form" name="form" method="POST" class="form-group" action="script_identification.php" >
...
<label for="uti_mdp" class="text_center"> <h4>Mot de passe</h4> </label>
      ...
      <h4> <a href='inscription.php' >si vous etes pas encore inscrit , merci de vous inscrire  par ici. </a></h4>