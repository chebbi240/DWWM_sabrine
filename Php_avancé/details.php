        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item ">
                        <a class="nav-link" href="listeA.php">Tableau</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="msg_supression.php"> Supprimer ce produit</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="form_modif.php">Modifier ce produit</a>
                    </li>
                </ul>            
            </div>
        </nav>
...
<h1 class= "text-center" >Detail du produit</h1>
  
<form action="listeA.php" method="POST" id="detail_produit">
    ...
    <label for="pro_bloque">Produit Bloqué 
      ...
      <br>
           ...
           <?php
        echo"<a href='form_modif.php?pro_id=$produit->pro_id'>Modifier"; ?>&nbsp
         &nbsp
         <?php echo"<a href='msg_supression.php?pro_id=$produit->pro_id'>supprimer";?>
