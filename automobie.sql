...
idreparition SMALLINT,
identretient SMALLINT,
idservices SMALLINT,
idemployes SMALLINT,
...
ALTER TABLE commande ADD(
CONSTRAINT FK_commande_'details_commande'
FOREIGN KEY (iddetails_commande)
REFERENCES iddetails_commande(details_commande)
)
...
ALTER TABLE véhicule ADD(
CONSTRAINT FK_véhicule_services
